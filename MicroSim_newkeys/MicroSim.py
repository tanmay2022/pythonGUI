...
class StartScreen(QDialog):
    ...
    def resizeEvent(self, event: QResizeEvent):
        ...
        if self.height() >850:
            ...
            self.frame5_elas.setGeometry( int((170*self.display_W)) , int((20*1.5*self.display_H)) , 331 , 300  )
            ...
            self.frame5_elas.setGeometry( int((170*self.display_W)) , int((20*self.display_H)) , 331 , 300  )
